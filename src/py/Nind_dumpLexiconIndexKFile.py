    ...
    try:
        ...
        for i in range(nombreIndirection):
            ...
            if offsetDefinition != 0: 
                ...
                if inFile2.litNombre3() != noDef: raise Exception('%d pas trouvé à %08X'%(noDoc, offsetDefinition+1))
                ...
                while inFile2.tell() < finDonnees:
                    ...
                    clefA = inFile2.litNombre4()
                    clefB = inFile2.litNombre4()
                    identifiantS = inFile2.litNombre3()
                    nbreComposes = inFile2.litNombreULat()
                    outFile.write('[%08X %08X] %06d (%d) '%(clefA, clefB, identifiantS, nbreComposes))
