...
////////////////////////////////////////////////////////////
//brief Creates NindLexiconF. */
NindLexiconF::NindLexiconF():
    m_currentId(0),
    m_lexiconSW(),
    m_lexiconCW()
{
...
unsigned int NindLexiconF::addWord(const list<string> &componants)
{
...
//param componants list of componants of a word (1 componant = simple word, more componants = compound word)
//return ident of word */
unsigned int NindLexiconF::getId(const list<string> &componants) const
{
    //identifiant du mot (simple ou compose) sous ensemble du mot examine
    unsigned int subWordId = 0;
    for(list<string>::const_iterator swIt = componants.begin(); swIt != componants.end(); swIt++) {
...
bool NindLexiconF::integrityAndCounts(struct LexiconSizes &lexiconSizes) const
{
...
void NindLexiconF::dump(std::ostream &out)
{
    string sep = "";
    for (StringHashMap::const_iterator it = m_lexiconSW.begin(); it != m_lexiconSW.end(); it++) {
...
////////////////////////////////////////////////////////////
size_t NindLexiconF::HashString::operator()(const string &s) const
{
...
bool NindLexiconF::EqualString::operator()(const string &s1, const string &s2) const
{
    return (s1 == s2);
};
////////////////////////////////////////////////////////////
size_t NindLexiconF::HashPair::operator()(const pair<unsigned int, unsigned int> &p) const
{
    unsigned int key = 0x55555555;        //0101...
    key ^= p.first;
    key ^= (p.second<<16);
...
bool NindLexiconF::EqualPair::operator()(const pair<unsigned int, unsigned int> &p1, const pair<unsigned int, unsigned int> &p2) const
{
    return (p1 == p2);
};
////////////////////////////////////////////////////////////
